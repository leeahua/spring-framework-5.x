...
public class ClassPathXmlApplicationContext extends AbstractXmlApplicationContext {
	 ...
	 * 从给定的xml文件创建一个新的ClassPathXmlApplicationContext ,并且可以自动刷新上下文内容
	 ...
	 * 从给定的多个xml文件创建一个新的ClassPathXmlApplicationContext ,并且可以自动刷新上下文内容
	...
	public ClassPathXmlApplicationContext(
			...
			throws BeansException {
		// 使用给定的父上下文创建一个新的 AbstractXmlApplicationContext, 如果没有指定parent，则为null
		// 设置资源模式匹配器
		super(parent);
		//设置配置文件信息
