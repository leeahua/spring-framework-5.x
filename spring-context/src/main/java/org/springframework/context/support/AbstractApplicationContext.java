...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	 ...
	 * 用于销毁此上下文管理的所有 bean 的模板方法。默认实现在此上下文中销毁所有缓存的单例，
	 * 调用 {@code DisposableBean.destroy()} 和或指定的“销毁方法”。
	 * <p>可以重写以在标准单例销毁之前或之后添加特定于上下文的 bean 销毁步骤，而上下文的 BeanFactory 仍处于活动状态。
	 * @see #getBeanFactory()
